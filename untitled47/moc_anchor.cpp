...
QT_MOC_LITERAL(3, 21, 11), // "textChanged"
QT_MOC_LITERAL(4, 33, 5), // "color"
QT_MOC_LITERAL(5, 39, 4) // "text"

    },
    "Anchor\0colorChanged\0\0textChanged\0color\0"
    "text"
};
...
void Anchor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Anchor::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Anchor::colorChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Anchor::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Anchor::textChanged)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Anchor::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Anchor.data,
      qt_meta_data_Anchor,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Anchor::colorChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Anchor::textChanged()
{
